...
public class BusService {
    ...
    public BusService() {
        ...
        busList.add(new Bus("1", "NeoTravels Premium", "AC Sleeper (2+1)", "22:00", "06:00", "8h 00m", 1200, 12, 4.5, "Mumbai", "Pune", "2023-10-25"));
        busList.add(new Bus("2", "CityExpress", "Non-AC Seater (2+2)", "20:30", "05:00", "8h 30m", 800, 24, 4.0, "Mumbai", "Pune", "2023-10-25"));
        busList.add(new Bus("3", "NightRider", "AC Volvo", "23:00", "06:30", "7h 30m", 1500, 5, 4.8, "Mumbai", "Pune", "2023-10-25"));
        busList.add(new Bus("4", "InterCity Gold", "AC Sleeper", "21:15", "05:45", "8h 30m", 1100, 15, 4.2, "Mumbai", "Pune", "2023-10-25"));
    }
